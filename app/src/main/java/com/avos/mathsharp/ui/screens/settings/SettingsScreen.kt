...
import com.avos.mathsharp.BuildConfig
...
fun SettingsScreen(onBack: () -> Unit) {
    ...
    Column(modifier = Modifier.fillMaxSize().padding(horizontal = 16.dp)) {
        ...
        Column(modifier = Modifier.padding(horizontal = 4.dp)) {
            ...
            Text(
                "MathSharp v${BuildConfig.VERSION_NAME}  ·  Offline  ·  Tanpa izin  ·  Tanpa iklan",
    ...
    if (showPrivacy) {
        AlertDialog(
            ...
            text = {
                Text(
                    "MathSharp TIDAK mengumpulkan data apa pun. Tanpa izin sistem, tanpa internet, " +
                        "tanpa iklan, tanpa analitik. Semua data (statistik, skor, streak) tersimpan " +
