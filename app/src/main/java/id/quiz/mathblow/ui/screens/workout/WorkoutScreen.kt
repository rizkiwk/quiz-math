...
import id.quiz.mathblow.ui.components.AnswerButton
import id.quiz.mathblow.ui.components.AnswerState
...
fun WorkoutScreen(
    ...
    // Sesi berpacu waktu (8 dtk/soal) — layar wajib tetap nyala tanpa izin WAKE_LOCK.
