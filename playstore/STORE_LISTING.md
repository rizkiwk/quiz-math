...
• Streak harian + pencapaian biar konsisten
• Statistik lengkap: akurasi, skor terbaik, riwayat
...
🧠 COCOK UNTUK
• Siapa pun yang ingin menjaga otak tetap tajam
• Latihan hitung cepat sebelum ujian atau wawancara
• Mengisi waktu luang dengan cara yang bermanfaat

Mulai latihan harianmu sekarang — otak yang tajam dilatih, bukan diwariskan. Kukuku.
```
...
• Daily streaks + achievements to keep you consistent
• Full stats: accuracy, best score, history
...
🧠 GREAT FOR
• Anyone who wants to keep their brain sharp
• Quick mental-math practice before exams or interviews
• Spending spare minutes in a useful way

Start your daily workout now — a sharp mind is trained, not inherited.
```

---

## 🗂️ Metadata Play Console
...
**Aset:** ikon 512×512 (`playstore/ic_launcher_playstore.png`) · feature graphic 1024×500 (`playstore/feature_graphic.png`) · screenshot HP (ambil dari app rilis: Dashboard, Workout, Result, Stats).
