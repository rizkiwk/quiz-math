package com.avos.mathsharp.ui.screens.onboarding
...
fun OnboardingScreen() {
    ...
    Column(
        ...
        Text("MathSharp", style = MaterialTheme.typography.displayMedium, color = cs.primary, fontWeight = FontWeight.Bold)
